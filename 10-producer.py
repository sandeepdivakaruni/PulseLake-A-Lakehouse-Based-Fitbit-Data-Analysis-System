...
class Producer():
    ...
    def profile_cdc(self, set_num):
        source = f"{self.Conf.kafkaTopic}/user_info/2-user_info_{set_num}.json"
    ...
    def workout(self, set_num):
        source = f"{self.Conf.kafkaTopic}/workout/4-workout_{set_num}.json"
    ...
    def bpm(self, set_num):
        source = f"{self.Conf.kafkaTopic}/bpm/3-bpm_{set_num}.json"
