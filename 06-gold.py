...
class Gold():
    ...
    def upsert_workout_bpm_summary(self, once=True, processing_time="15 seconds", startingVersion=0):
        ...
        a.avg_bpm        = b.avg_bpm,
        a.max_bpm        = b.max_bpm,
        a.num_recordings = b.num_recordings
        ...
        df_delta = (spark.readStream
                        ...
                        # .withWatermark("end_time", "365 days")
                         .groupBy("user_id", "workout_id", "session_id", "start_time", "end_time")
                         ...
                         .select("workout_id", "session_id", "user_id","start_time", "end_time", "age", "gender", "city", "state", "min_bpm", "avg_bpm", "max_bpm", "num_recordings")
                     )
